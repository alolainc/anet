...
/* DOC:
 * ShardQueue uses the anet's nocopy API to merge and send data.
 ...
 * NewShardQueue: create a queue with anet.Connection.
...
// NewShardQueue .
func NewShardQueue(size int, conn anet.Connection) (queue *ShardQueue) {
	queue = &ShardQueue{
		conn:    conn,
		size:    int32(size),
...
// WriterGetter is used to get a anet.Writer.
type WriterGetter func() (buf anet.Writer, isNil bool)
...
// deal is used to get deal of anet.Writer.
...
// flush is used to flush anet.Writer.
